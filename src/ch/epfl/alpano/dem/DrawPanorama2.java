...
final class DrawPanorama2 {
    ...
    final static double ORIGIN_LON = toRadians(7.62191);
    final static double ORIGIN_LAT = toRadians(46.05032);
    final static int ELEVATION = 800;
    final static double CENTER_AZIMUTH = toRadians(270);
    final static double HORIZONTAL_FOV = toRadians(65);
    ...
    public static void main(String[] as) throws Exception {
      try (DiscreteElevationModel dDEM = new CompositeDiscreteElevationModel(
           new HgtDiscreteElevationModel(HGT_FILE), new HgtDiscreteElevationModel(HGT_FILE2))) {
